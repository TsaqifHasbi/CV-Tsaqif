export default function SocialLinks({ socialLinks, size = 'default' }) {
    const getSocialIcon = (platform) => {
        const icons = {
            ...
            dribbble: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0C5.372 0 0 5.373 0 12s5.372 12 12 12c6.627 0 12-5.373 12-12S18.627 0 12 0z" />
                </svg>
            ),
        };
        ...
        <div className="flex items-center gap-3">
            {socialLinks.map((link, index) => (
                <a
                    ...
                    className={`btn-icon ${sizeClasses} animate-fade-in`}

        ...
        <AdminLayout title="Add Certification">
            ...
            <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
                <div className="glass-card p-6 rounded-xl space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" value={data.title} onChange={(e) => setData('title', e.target.value)} className="form-input" required placeholder="e.g., AWS Solutions Architect" />
                            {errors.title && <p className="text-red-500 text-sm mt-1">{errors.title}</p>}
                        </div>
                        <div>
                            <label className="form-label">Issuer *</label>
                            <input type="text" value={data.issuer} onChange={(e) => setData('issuer', e.target.value)} className="form-input" required placeholder="e.g., Amazon Web Services" />
                        </div>
                        <div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <input type="url" value={data.credential_url} onChange={(e) => setData('credential_url', e.target.value)} className="form-input" placeholder="https://..." />
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-4">
                    <button type="submit" disabled={processing} className="btn-primary">{processing ? 'Saving...' : 'Save Certification'}</button>

        ...
        <AdminLayout title="Social Links">
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <p className="text-gray-500">Manage your social media links</p>
                ...
                <div className="glass-card rounded-xl overflow-hidden">
                    {socialLinks?.length ? (
                        <table className="data-table">
                            ...
                            <tbody>
                                {socialLinks.map((item) => (
                                    <tr key={item.id}>
                                        <td className="text-gray-900 font-medium capitalize">{item.platform}</td>
                                        <td className="text-gray-600 truncate max-w-xs"><a href={item.url} target="_blank" rel="noopener noreferrer" className="hover:text-rose-500">{item.url}</a></td>
                        ...
                        <div className="p-12 text-center"><p className="text-gray-500 mb-4">No social links yet</p><Link href={route('admin.social-links.create')} className="btn-primary">Add Your First Link</Link></div>
                    )}
                </div>
            </div>
        </AdminLayout>

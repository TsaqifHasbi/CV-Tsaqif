        ...
        <AdminLayout title="Add Skill">
            ...
            <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
                <div className="glass-card p-6 rounded-xl space-y-6">
                    <div><label className="form-label">Skill Name *</label><input type="text" value={data.name} onChange={(e) => setData('name', e.target.value)} className="form-input" required placeholder="e.g., JavaScript, Laravel, React" />{errors.name && <p className="text-red-400 text-sm mt-1">{errors.name}</p>}</div>

            ...
            <div className="space-y-6">
                ...
                <div className="glass-card rounded-xl overflow-hidden">
                    {skills?.length ? (
                            ...
                            <tbody>
                                {skills.map((item) => (
                                    <tr key={item.id}>
                                        ...
                                        <td><div className="flex items-center gap-2"><div className="w-24 h-2 bg-dark-700 rounded-full overflow-hidden"><div className="h-full bg-gradient-to-r from-primary-500 to-accent-500" style={{ width: `${item.proficiency_level}%` }}></div></div><span className="text-gray-400 text-sm">{item.proficiency_level}%</span></div></td>
                        ...
                        <div className="p-12 text-center"><p className="text-gray-400 mb-4">No skills added yet</p><Link href={route('admin.skills.create')} className="btn-primary">Add Your First Skill</Link></div>
                    )}
                </div>
            </div>
        </AdminLayout>

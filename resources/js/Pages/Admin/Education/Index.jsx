        ...
        <AdminLayout title="Education">
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <p className="text-gray-400">Manage your education history</p>
                    ...
                    {education && education.length > 0 ? (
                        <table className="data-table">
                            ...
                            <tbody>
                                {education.map((item) => (
                                    <tr key={item.id}>
                                        <td className="text-white font-medium">{item.institution}</td>
                                        <td className="text-gray-400">{item.degree}</td>
                                        <td className="text-gray-400">{item.start_year} - {item.end_year || 'Present'}</td>
                        ...
                        <div className="p-12 text-center">
                            <svg className="w-12 h-12 text-gray-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 14l9-5-9-5-9 5 9 5z" /></svg>
